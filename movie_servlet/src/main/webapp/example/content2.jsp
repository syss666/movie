...
<div class="mainview">
        ...
        <!-- 페이지 전달위한 폼 -->
        <form name = "p_form" method="get" action="/movie/content2.jsp">
...
<script>
	...
	const APIURL ="https://api.themoviedb.org/3/movie/popular?api_key=d33ccc9950f589a6d0b4d5c2f8f63e31&language=ko&page=1";
